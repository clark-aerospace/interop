...
for drone_cli.py
```bash
./tools/drone_cli.py --url udp://127.0.0.1:14551 send_mission --mission_id 1 --interop_url http://127.0.0.1:8000 --interop_username testuser --interop_password testpass
```
